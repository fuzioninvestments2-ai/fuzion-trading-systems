---
name: 20-deployment
description: Arranque, lanzadores .bat, robot 24/7 y subida a la nube (dos carpetas separadas OTC/REAL). Úsalo cuando el usuario diga "arrancar el bot", "el .bat", "robot automático", "subir a la nube", "que corra solo", "reiniciar", o al tocar los lanzadores / accumulator / cloud_push.
---
